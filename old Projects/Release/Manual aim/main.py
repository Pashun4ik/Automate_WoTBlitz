...
def garage_menu():
    ...
    while 1:
        ...
        while look_in_store:
            ...
            sub_offset_from_y = int(mon_height * 0.065)
        ...
        while look_at_containers:
            ...
            modify_common = ContourDilation(bgr_common, 0, 10, 20, 255, 100, 255, kernel_x)
            ...
            modify_big = ContourDilation(bgr_big, 0, 10, 20, 255, 100, 255, kernel_x)
            ...
            modify_huge = ContourDilation(bgr_huge, 0, 10, 20, 255, 100, 255, kernel_x)
